<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Object.aspx.cs" Inherits="WebAppSTS.Object" Async="true" MasterPageFile="~/Site.Master"%>
    ...
    <div class="jumbotron">
     ...
     <h1>  Работа с объектами </h1>
        ...
        <p class="lead"> 
            &nbsp;</p>
        <p class="lead"> 
            <asp:Button ID="AddWorkers" runat="server" Text="Добавить рабочую группу" Width="370px" OnClick="AddWorkers_Click"/>
        ...
        <p class="lead"> 
            ...
            <asp:Button ID="DelWorkers0" runat="server" Text="Список рабочих групп" Width="370px" OnClick="DelWorkers0_Click"/>


            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="ListObject" runat="server" Text="Список объектов" Width="370px" OnClick="ListObject_Click"/>
        ...
        <p class="lead"> 
            <asp:Label ID="LabelText1" runat="server" ForeColor="Black" Width="140px" Font-Size="Medium" Visible="False">Проверка тек</asp:Label>


            <asp:Label ID="LabelText2" runat="server" ForeColor="Black" Width="140px" Font-Size="Medium" Visible="False">Проверка тек</asp:Label>


            <asp:Label ID="LabelText3" runat="server" ForeColor="Black" Width="140px" Font-Size="Medium" Visible="False">Проверка тек</asp:Label>


            <asp:Label ID="LabelText4" runat="server" ForeColor="Black" Width="140px" Font-Size="Medium" Visible="False">Проверка тек</asp:Label>


            <asp:Label ID="LabelText5" runat="server" ForeColor="Black" Width="140px" Font-Size="Medium" Visible="False">Проверка тек</asp:Label>


            <asp:Label ID="LabelText6" runat="server" ForeColor="Black" Width="140px" Font-Size="Medium" Visible="False">Проверка тек</asp:Label>
